      ...
      <nav className="fixed top-0 w-full z-[100] bg-[#030712]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          ...
          <button
            ...
            className="text-[10px] font-black tracking-[0.2em] bg-emerald-500 text-black px-6 py-2.5 rounded-sm hover:bg-emerald-400 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] transition-all uppercase"
          >
